...
import { Wallet, Star, Clock, CheckCircle, User } from 'lucide-react';
      ...
      <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
        <div className="flex items-center gap-6">
          ...
          <button 
            ...
            onClick={() => !wallet.address && connect()}
          >
            <Wallet className="w-5 h-5 mr-2" />
            {wallet.address ? `${wallet.balance} XION` : 'Connect Wallet'}
          </button>
        </div>
      </div>
        ...
        <>
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
              ...
              <p className="text-3xl font-bold">{wallet.balance} XION</p>
            </div>
          </div>
